...
def config_parser():
    ...
    parser.add_argument("--lr", type=float, default=0.0001,
                        help='Learning rate used during training.1e-6')
    ...
    parser.add_argument("--max_depth", type=float, help="the max depth of projected rays", default=16)
    parser.add_argument("--alpha", type=float, help="the value by which the stepping distance should be multiplied, default is 0.6",
                        default=0.6)
    parser.add_argument("--step_back", type=float, default=0.005, help="the value by which we step back after stopping criteria met")
    parser.add_argument("--epsilon", type=float, default=0.0026, help="epsilon ball - stopping criteria, default 0.0026")
    parser.add_argument("--screen_bound", type=float, default=0.4)
    parser.add_argument("--screen_depth", type=float, default=-1)

    parser.add_argument('--cam_position', nargs='+', type=float, help='3D position of camera',
                        default=[0, -1.5, 0])
    parser.add_argument('--light_position', nargs='+', type=float, help='3D position of light source',
                        default=[-1, -1, -1])
    parser.add_argument("--cam_orientation", nargs='+', type=float, help="Camera Orientation in xyz euler angles (degrees)",
                        default=[90.0, 0.0, 0.0])
    parser.add_argument('--gt_obj_position', nargs='+', type=float, help='3D position of obj in Radiant',
                        default=[0, 0, 0])
