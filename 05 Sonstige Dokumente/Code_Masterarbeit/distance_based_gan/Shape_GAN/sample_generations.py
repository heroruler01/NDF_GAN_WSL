...
counter = 0
while counter < 500:
    checkpoint_path = "/home/sebastian/ndf_gan/experiments/pointnet_max_fourier_sigma1_watertight/"
    ...
    voxel_origin = [-1.05, -1.05, -1.05]
    voxel_size = 2.1 / (256 - 1)
    ...
    def convert_sdf_samples_to_ply(
        ...
        plyname = str(counter) + ply_filename_out
        ply_data = plyfile.PlyData([el_verts, el_faces])
        logging.debug("saving mesh to %s" % (plyname))
        ply_data.write("test_generation/" + plyname)
    ...
    # transform first 3 columns --> hier wird einfach in die ersten drei Spalten 255 eingefügt!
