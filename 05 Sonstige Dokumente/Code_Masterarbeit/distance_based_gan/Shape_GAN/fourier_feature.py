...
class FourierFeatures(torch.nn.Module):
    ...
    def __init__(self, frequency_matrix, learnable_features=False):
        ...
        if learnable_features:
            self.frequency_matrix = torch.nn.Parameter(frequency_matrix)
        else:
    ...
    def forward(self, coordinates):
        ...
        return torch.cat((cos_features, sin_features), dim=2) # dim 2 for train point gan and pc_renderer, 1 for renderer_fourier