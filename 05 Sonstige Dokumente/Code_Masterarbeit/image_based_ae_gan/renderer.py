...
class Renderer():
    ...
    def save_images(self):
        ...
        stacked_img = self.save(shade, 'shade.jpg', 1, True)
        return stacked_img
...
def pred_render(model, inputs, sd, time_array):
    start_time = time.time()
    renderer = Renderer()
    renderer.run(model, inputs, sd)
