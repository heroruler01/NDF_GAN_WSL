...
class VoxelizedDataset(Dataset):
    ...
    def __init__(self, mode, res, pointcloud_samples, data_path, split_file ,
        ...
        self.num_sample_points = num_sample_points # das hier ist die Anzahl der eigentlichen Punkte im training
    ...
    def __getitem__(self, idx):
        try:
            ...
            #path = "/home/sebastian/ndf-master/datasets/shapenet/data"+self.data[idx] #path für renderer
            #path = "/home/sebastian/ndf-master/" + self.data[idx]  # path für train lightshapenet
            path = self.data[idx]  # path für train shapenet_all
            input_path = path
            samples_path = path
